...
// Each summary:        ~190–210 words, 4 hallucinations (comprehension errors).
...
const TASK_T1B: StudyTask = {
  ...
  timeLimitMinutes: 6,
  sourceDocument:
`The translation into clinical medicine came in 1948, when epidemiologist Austin Bradford Hill designed the first properly randomized clinical trial — a study of streptomycin as a treatment for pulmonary tuberculosis, conducted under the auspices of the Medical Research Council. Patients were assigned to receive streptomycin or standard bed rest using sealed envelopes containing random assignments. The trial demonstrated that streptomycin significantly improved outcomes. In 1965, Bradford Hill published a paper articulating nine criteria by which a statistical association between an exposure and a disease could be judged as causal. These became known as the Bradford Hill criteria and remain a standard reference in epidemiology. When thalidomide, prescribed for morning sickness in the late 1950s, was found by the early 1960s to cause severe limb malformations in newborns, the FDA used the crisis to mandate randomized evidence for all new drug approvals. The Cochrane Collaboration, established in 1993 in Oxford, formalized this infrastructure by systematically aggregating RCT evidence into reviews that now inform clinical guidelines worldwide.`,
  hallucinatedSummary:
