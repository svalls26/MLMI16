...
//
// Each source article: ~230–260 words.
...
The idea of replacing analogical reasoning with mathematics was first proposed seriously by Lewis Fry Richardson, a British mathematician and meteorologist who during World War I applied hydrodynamic equations to an actual weather event. After six weeks of laborious manual calculation, he found that his method produced a wildly inaccurate result — the equations had amplified small measurement errors into nonsense. Richardson published his method, along with a careful diagnosis of why it had failed, in his 1922 book Weather Prediction by Numerical Process. The book included a famous thought experiment: a spherical "forecast factory" staffed by 64,000 human "computers" working in parallel, each responsible for a small region of the atmosphere, all coordinated by a conductor at the centre. The factory was a fantasy, but the equations it would use were real.`,
  hallucinatedSummary:
`Before the computer age, weather forecasting relied on pattern recognition: meteorologists searched historical records for atmospheric configurations similar to the present, then assumed that what followed before would follow again. The approach was systematic but inherently subjective, and useful forecasts extended little more than a day or two into the future.

The alternative — replacing analogy with mathematics — was first pursued seriously by Lewis Fry Richardson, a British physicist and meteorologist who applied hydrodynamic equations to a real weather event during World War I. Six weeks of hand calculation yielded a result that was wildly inaccurate; small measurement errors had been amplified into nonsense by the equations. Richardson nevertheless published the work in his 1922 book Weather Prediction by Numerical Process. The book contained a famous thought experiment: completing a forecast in real time would require a spherical "forecast factory" staffed by 640,000 human "computers" working in parallel, each calculating the atmosphere over a small region, coordinated by a central conductor. The factory was imaginary; the mathematics was not.`,
};
